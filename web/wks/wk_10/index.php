...
<html>
    <head>
        <title>Week 10 | CSE 341 - Back End Development II</title>
...
<div class="row">
    ...
    <main>
        ...
        <h3>Describe the component that you completed from end-to-end:</h3>
            <p>I have the design implemented and can send requests to the Google Book API but cannot recieve the information to be processed</p>
        ...
        <h3>Provide a brief justification (1-2 sentences) for selecting that category.</h3>
            <p>Honestly I put crazy amounts of time into doing this app so far and it still short from what I expected.<p>

        <h3>Please list any questions you have for the instructor regarding this assignment or this week's topic.</h3>
            <p>Why is this class made to be so difficult that even after hundreds of hours of studying I feel like I haven't ctually learned anything?</p>
    </main>
</div>
    <footer>
